# @imhelper/protocol-onebot-11

imhelper OneBot V11 协议实现 - 支持 OneBot 11 标准的协议插件

## 简介

`@imhelper/protocol-onebot-11` 是 imhelper 框架的官方 OneBot V11 协议实现，完全兼容 [OneBot 11 标准](https://github.com/botuniverse/onebot-11)，提供 HTTP、WebSocket 等多种通信方式。
...
# 或
pnpm add @imhelper/protocol-onebot-11
```
...
```bash
# 注册 OneBot V11 协议
imhelper -p onebot-v11

# 同时注册多个协议
imhelper -p onebot-v11 -p onebot-v12 -p satori-v1
...
协议会自动从以下位置加载：
- `@imhelper/protocol-onebot-11` (官方包)
- `imhelper-protocol-onebot-v11` (社区包)
- `onebot-v11` (直接包名)
