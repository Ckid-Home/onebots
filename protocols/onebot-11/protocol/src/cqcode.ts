import { CommonTypes,Dict } from "imhelper";
...
export namespace CQCode {
     ...
     */
    export function encode(segment: CommonTypes.Segment): string {
     ...
     */
    export function stringify(segments: CommonTypes.Segment[]): string {
     ...
     */
    export function parse(message: string): CommonTypes.Segment[] {
     ...
     */
    export function toText(segments: CommonTypes.Segment[]): string {
        return segments
     ...
     */
    export function hasSegmentType(segments: CommonTypes.Segment[], type: string): boolean {
     ...
     * Create text segment
     */
    export function text(text: string): CommonTypes.Segment {
     ...
     */
    export function face(id: number | string): CommonTypes.Segment {
     ...
     * Create at segment
     */
    export function at(qq: number | string | "all"): CommonTypes.Segment {
     ...
     */
    export function reply(id: number | string): CommonTypes.Segment {
     ...
     */
    export function forward(id: string): CommonTypes.Segment {
    ...
    export function node(options: {
        ...
        user_id?: number;
        nickname?: string;
        content?: CommonTypes.Segment[] | string;
    }): CommonTypes.Segment {
        return {
            type: "node",
            data: options,
     ...
     * Create poke segment
     */
    export function poke(type: string, id: string): CommonTypes.Segment {
     ...
     */
    export function anonymous(ignore?: boolean): CommonTypes.Segment {
        return {
            type: "anonymous",
     ...
     */
    export function shake(): CommonTypes.Segment {
     ...
     * Create JSON segment
     */
    export function json(data: string | object): CommonTypes.Segment {
        return {
            type: "json",
     ...
     * Create XML segment
     */
    export function xml(data: string): CommonTypes.Segment {
